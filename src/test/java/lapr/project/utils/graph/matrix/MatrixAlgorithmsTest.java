...
class MatrixAlgorithmsTest {
    ...
    Graph<String,Integer> nullMap = new MatrixGraph<>(false);
    ...
    public void testminDistGraph() {
        ...
        System.out.println("Test of minDistGrap");

        
        Algorithms.minDistGraph(completeMap, Integer::compare, Integer::sum);
        
        assertNull(Algorithms.minDistGraph(nullMap, Integer::compare, Integer::sum));
        
        Graph<String,Integer> minDistGraph = new MatrixGraph<>(false);
        minDistGraph = Algorithms.minDistGraph(completeMap, Integer::compare, Integer::sum);
        
        List<String> vrts = new ArrayList<>();
        vrts.addAll(minDistGraph.vertices());        
        assertNull(minDistGraph.edge("Porto", "Porto"));        
        assertEquals(minDistGraph.edge("Porto", "Braga").getWeight(), 60);
        
        assertNotEquals(completeMap, minDistGraph);
        
        LinkedList<String> shorthPath1 = new LinkedList<>();
        Algorithms.shortestPath(completeMap, "Porto", "Lisboa", Integer::compare, Integer::sum, 0, shorthPath1);
        
        LinkedList<String> shorthPath2 = new LinkedList<>();
        Algorithms.shortestPath(minDistGraph, "Porto", "Lisboa", Integer::compare, Integer::sum, 0, shorthPath2);
        
        
        assertTrue(shorthPath1.size()>shorthPath2.size());              
